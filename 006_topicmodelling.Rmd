...
### 49 topics
```{r}
f_ldaOut38 <- LDA(dtmf,38, method="Gibbs", control=
              list(nstart=10, seed = sample.int(10000,10), best=TRUE, burnin = 1000, iter = 2000, thin=500))


topics(f_ldaOut38)
f_ldaOut.topics38 <-as.matrix(topics(f_ldaOut38))
terms(f_ldaOut38,20)
f_ldaOut.terms38 <- as.matrix(terms(f_ldaOut38,20))
#Find probabilities associated with each topic assignment
f_topicProbabilities38 <- as.data.frame(f_ldaOut38@gamma)
```
